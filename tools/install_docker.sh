...
wget -O --no-check-certificate boost_`echo ${BOOST_VERSION}|tr "." "_"`.tar.gz http://sourceforge.net/projects/boost/files/boost/${BOOST_VERSION}/boost_`echo ${BOOST_VERSION}|tr "." "_"`.tar.gz/download 
