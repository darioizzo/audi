...
# Configuration step.
if is_python_build:
    run_command(r'cmake -G "MinGW Makefiles" ..  -DBUILD_TESTS=no -DBUILD_PYKEP=yes -DCMAKE_BUILD_TYPE=Release ' + common_cmake_opts + r' -DBoost_PYTHON_LIBRARY_RELEASE=c:\\local\\lib\\libboost_python' +
